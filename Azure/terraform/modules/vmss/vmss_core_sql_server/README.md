# FME Flow Core VMSS module using Azure SQL Server
This module creates the virtual machine scale set for the FME Core of a distributed FME Flow deployment using a Azure SQL Server backend database.
<!-- BEGIN_TF_DOCS -->
## Requirements
